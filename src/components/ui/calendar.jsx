  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "text-color-01 hover:text-color-08 focus:text-color-01",
        day_today: "text-color-08",
        day_outside:
          "day-outside text-color-08/10",
      ...
      components={{
        IconLeft: ({ className, ...props }) => (
          <Image src={IconArrowLeft} alt="arrow-left" className={cn(className)} {...props} />
        ),
        IconRight: ({ className, ...props }) => (
          <Image src={IconArrowRight} alt="arrow-right" className={cn(className)} {...props} />
        ),
      }}
      {...props} />)
  );
