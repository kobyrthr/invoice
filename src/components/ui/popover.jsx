...
<PopoverPrimitive.Trigger ref={ref} className={cn("border text-regular h-12 border-color-05 data-[state=open]:border-color-01 focus-visible:!border-color-02 focus-visible:outline-none rounded-md", className)} {...props} />
))
